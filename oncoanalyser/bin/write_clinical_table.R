...
if (opt$mode == "patient") {
  ...
  col_defs <- list(
    ...
    list("CANCER_TYPE_LABEL",          "cancer_type_label",                  "Cancer Code Label",           "Human-readable label for the ICD-O-3 topography cancer code.",         "STRING", "1"),
    ...
    list("TUMOR_TISSUE_SITE",        "specimen_anatomic_location",         "Tumor Tissue Site",           "Anatomic location of the specimen (ICD-O code).",                      "STRING", "1"),
    list("TUMOR_TISSUE_SITE_LABEL",  "specimen_anatomic_location_label",   "Tumor Tissue Site Label",     "Human-readable label for the anatomic location of the specimen.",      "STRING", "1"),
