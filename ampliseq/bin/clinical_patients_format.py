...
HEADER_LINES = [
    ...
    "#Patient identifier\tMarathon of Hope Identification\tAge at which the condition was first diagnosed, in years\tSex\tOverall Survival Status\tOverall survival in months since initial diagnosis\tSmoking history",
